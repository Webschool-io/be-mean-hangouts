...
/**
 Base class for all Brincando_1 views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Brincando_1 view hierarchy (such as wrapped iOS UIViews) was touched.
