...
@interface Brincando_1Object : KrollCoverageObject {
#else
@interface Brincando_1Object : KrollObject {
#endif
@private
...
extern NSString * Brincando_1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Brincando_1Object *_brincando_1;
    KrollObject* console;
	BOOL shutdown;
