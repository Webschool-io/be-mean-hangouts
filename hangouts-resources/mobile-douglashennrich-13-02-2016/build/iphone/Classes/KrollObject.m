...
//@interface Brincando_1Object : NSObject
//@end

@interface Brincando_1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Brincando_1Object class]])
		{
			for (NSString *key in [[(Brincando_1Object*)o modules] allKeys])
			{
