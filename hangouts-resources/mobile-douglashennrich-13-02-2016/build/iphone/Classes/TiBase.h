...
// in simulator we redefine to format for Brincando_1 Developer console
...
{\
	NSString * exceptionName = [@"org.brincando_1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.brincando_1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBrincando_1NativeItemNone = -1, 
	UIBrincando_1NativeItemSpinner = -2,
	UIBrincando_1NativeItemProgressBar = -3,
	
	UIBrincando_1NativeItemSlider = -4,
	UIBrincando_1NativeItemSwitch = -5,
	UIBrincando_1NativeItemMultiButton = -6,
	UIBrincando_1NativeItemSegmented = -7,
	
	UIBrincando_1NativeItemTextView = -8,
	UIBrincando_1NativeItemTextField = -9,
	UIBrincando_1NativeItemSearchBar = -10,
	
	UIBrincando_1NativeItemPicker = -11,
	UIBrincando_1NativeItemDatePicker = -12,
	
	UIBrincando_1NativeItemInfoLight = -13,
	UIBrincando_1NativeItemInfoDark = -14,
	
	UIBrincando_1NativeItemDisclosure = -15,
	
	UIBrincando_1NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Brincando_1 instances of
