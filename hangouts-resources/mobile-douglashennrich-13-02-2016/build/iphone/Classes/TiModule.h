...
/**
 The base class for all Brincando_1 modules
 */
...
/**
 Brincando_1 Platform calls this method on startup.
 */
-(void)startup;

/**
 Brincando_1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Brincando_1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Brincando_1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Brincando_1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
